...
const en: Record<string, string> = {
  ...
  'tier.best': 'the most capable',
  'tier.balanced': 'great all-rounder',
...
const de: Record<string, string> = {
  ...
  'tier.best': 'das fähigste',
  'tier.balanced': 'starker Allrounder',
...
const es: Record<string, string> = {
  ...
  'tier.best': 'la más capaz',
  'tier.balanced': 'gran todoterreno',
...
const fr: Record<string, string> = {
  ...
  'tier.best': 'le plus capable',
  'tier.balanced': 'excellent partout',
